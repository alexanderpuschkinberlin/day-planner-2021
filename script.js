class TimeblockObj {
  ...
  // function to show the time block rows
  function displayTimeblockRows(currentTime) {
    const currentHour = currentTime.hour();
    //for the rows we have working hours 9-17
    for (let i = 9; i <= 17; i ++) {
  ...
  // fuction to change he color of the input areas according to current and past time
